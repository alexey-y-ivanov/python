...
with open ("task6.txt", "r") as my_file:
    for line in my_file:
        subject, hours = line.split(':') # separating subject and hours
        subject_sum = sum(int(n) for word in hours.split() for n in word.split('(') if n.isdigit()) # extracting hours standing before (
