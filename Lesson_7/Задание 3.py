...
class Cell:
    ...
    def __add__(self, other):
        return f'The total quantity of cells is {self.quantity + other.quantity}'

    def __sub__(self, other):
        sub = self.quantity - other.quantity
        return f'The quantity of cells reduced to {sub}' if sub > 0 else 'The quantity of cells is inappropriate!'
